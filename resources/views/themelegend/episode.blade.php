...
@section('content')
    ...
    <div class="block-wrapper page-single" id="block-player">
        ...
        <div id="watch-block" class="small-player">
            ...
            <div class="media-player uniad-player" id="media-player-box">
			    ...
			    @if (get_theme_option('thong_bao'))
        
            <div style="margin-bottom:20px;border: 1px solid #B8B612;padding: 5px;text-align: center;">
                {!! get_theme_option('thong_bao') !!}
            </div>
    ...
    @endif
            ...
            <div class="user-action">
                ...
                <div class="box-rating">
                    ...
                    <p>Đánh giá phim <span class="num-rating">({{ number_format($currentMovie->rating_star ?? 0, 1) }} sao
	...
	<span class="hidden" itemprop="itemReviewed" itemscope itemtype="https://schema.org/Restaurant"> 
		...
		<span itemprop="name">OPHIM.INFO</span>
