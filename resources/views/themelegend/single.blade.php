...
@php
    $years = Cache::remember('all_years', \Backpack\Settings\app\Models\Setting::get('site_cache_ttl', 5 * 60), function () {
        return \Chilltv\Core\Models\Movie::select('publish_year')
            ->distinct()
            ->pluck('publish_year')
            ->sortDesc();
    });
...
@section('content')
    ...
    <div class="block-wrapper page-single" itemscope itemtype="https://schema.org/Movie">
                    ...
                    <div class="col-6 movie-detail">
                        ...
                        <div class="movie-meta-info">
                            <dl class="movie-dl">
								...
								<dt class="movie-dt"><a target="_blank" rel="noopener" href="https://chilltv.xyz" style="color: #ff000000;">chilltv.xyz</a></dt><br>
                            </dl>
                            <div class="clear"></div>
                        </div>
                        <div class="box-rating">
                            ...
                            <span class="hidden" itemprop="aggregateRating" itemscope
								...
								<span class="hidden" itemprop="itemReviewed" itemscope itemtype="https://schema.org/Restaurant">
        <img itemprop="thumbnailUrl" src="{{ $currentMovie->thumb_url }}" alt="{{ $currentMovie->name }}">
         <img itemprop="image" src="{{ $currentMovie->thumb_url }}" alt="{{ $currentMovie->name }}">
        <span itemprop="name">CHILLTV.XYZ</span>
        <span itemprop="servesCuisine">Xem Phim Online Mới Nhất 2023</span>
      </span>
                                <span
	  ...
	  <span itemprop="name">CHILLTV.XYZ</span>
          <span class="hidden" itemprop="quality">{{ $currentMovie->quality }}</span>
		  <span class="hidden" itemprop="language">{{ $currentMovie->language }}</span>
		  <span class="hidden" itemprop="year">{{ $currentMovie->publish_year }}</span>
		  </span>
