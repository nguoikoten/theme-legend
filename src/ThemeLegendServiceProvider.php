...
class ThemeLegendServiceProvider extends ServiceProvider
{
    ...
    protected function setupDefaultThemeCustomizer()
    {
        config(['themes' => array_merge(config('themes', []), [
            'legend' => [
                'name' => 'Legend',
                'author' => 'chilltv@gmail.com',
                'package_name' => 'chilltvcms/theme-legend',
                ...
                'options' => [
                    ...
                    [
                        ...
                        <div class="bar">
                            <div class="bar-wrap">
                                <div class="links">
                                    <img src="{{ asset('images/logo.jpg') }}" alt="ChillTV" />
                                    <br>
                                    <div class="copyright">Copyright 2023 © <a href="/" title="CHILLTV">CHILLTV</a>
                                        <br />
                                        <p>
